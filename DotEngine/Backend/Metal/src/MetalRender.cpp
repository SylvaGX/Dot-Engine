...
// Those are driven by the UI module's Begin/End.
...
namespace DotEngine::Renderer {
    ...
    void Clear(float /*r*/, float /*g*/, float /*b*/, float /*a*/) {
        // Metal clear colour is set on the render pass descriptor in UI::Begin
    }
    ...
    void Present(EngineContext& /*ctx*/) {
        // Metal presentation is committed in UI::End via command buffer
    }
